        ...
        {depositModal && (
          <div className="space-y-3">
            <p className="text-sm text-navy-800">
              <span className="font-bold">{(getUser(depositModal.userId)?.nickname || getUser(depositModal.userId)?.name)}{depositModal.items[0]?.depositorName ? `(${depositModal.items[0].depositorName})` : ''}</span>님의{' '}
